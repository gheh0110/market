...
<html class="no-js" lang="">
   ...
   <link rel="shortcut icon" type="image/png" href="images/agri_logo.png"/>
   <head>
      <meta charset="utf-8">
         ...
         <header id="header" class="header">
            <div class="top-left">
               <div class="navbar-header">
                  <a class="navbar-brand" href="index.php"><img src="images/agri_logo.png" alt="Logo"></a>
                  <a class="navbar-brand hidden" href="index.php"><img src="images/agri_logo.png" alt="Logo"></a>
